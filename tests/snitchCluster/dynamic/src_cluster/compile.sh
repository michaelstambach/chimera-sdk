...
/app/install/llvm/bin/clang --target=riscv32-unknown-elf -I /workspaces/chimera-sdk/build/picolibc-install/include -I /workspaces/chimera-sdk/targets/chimera-open/inc -I /workspaces/chimera-sdk/devices/snitch_cluster -I ../include -ggdb -gdwarf-4 -gstrict-dwarf -O2 -march=rv32imafd_xdma -mabi=ilp32 -std=gnu11 -c *.c -fPIC -mno-relax -shared

# link them to shared objects
/app/install/llvm/bin/clang --target=riscv32-unknown-elf -L /workspaces/chimera-sdk/build/picolibc-install/lib/rv32im/ilp32 -L /app/install/llvm/lib/clang/15.0.0/lib/baremetal/rv32im/ -Xlinker -shared -o test_cluster.so test_cluster.o
